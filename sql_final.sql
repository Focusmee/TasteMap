...
('狮子头','热菜',520, JSON_OBJECT('protein_g',22,'fat_g',38,'carb_g',18,'sodium_mg',780), JSON_ARRAY('小麦'), JSON_ARRAY('高脂','高盐'), '经典淮扬菜，建议搭配蔬菜与粗粮。'),
('北京烤鸭','热菜',460, JSON_OBJECT('protein_g',28,'fat_g',30,'carb_g',22,'sodium_mg',690), JSON_ARRAY('小麦'), JSON_ARRAY('高蛋白'), '去皮可明显降低脂肪摄入。'),
('麻婆豆腐','热菜',380, JSON_OBJECT('protein_g',18,'fat_g',26,'carb_g',14,'sodium_mg',960), JSON_ARRAY('大豆'), JSON_ARRAY('微辣','重口'), '控盐可用低盐豆瓣酱。'),
('清蒸鱼','热菜',240, JSON_OBJECT('protein_g',32,'fat_g',10,'carb_g',2,'sodium_mg',420), JSON_ARRAY('海鲜'), JSON_ARRAY('低脂','高蛋白'), '适合增肌或减脂人群。'),
('燕麦牛奶','饮品',180, JSON_OBJECT('protein_g',6,'fat_g',4,'carb_g',28,'sodium_mg',120), JSON_ARRAY('牛奶','小麦'), JSON_ARRAY('高纤维'), '早餐搭配水果更均衡。')
ON DUPLICATE KEY UPDATE calories=VALUES(calories), nutrition=VALUES(nutrition), allergens=VALUES(allergens);
